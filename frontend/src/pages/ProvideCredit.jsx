...
function ProvideCredit() {
  ...
  const baseRate = 0.04;
  const utilizationMultiplier = 0.1;
  const currentAPR =
    (baseRate + utilizationMultiplier * poolStats.utilization) * 100;
  ...
  const handleDeposit = async () => {
    ...
    try {
      ...
      showAlert(
        `Successfully deposited ${amount} USDC into the Credit Pool.`,
        "success",
        "Deposit Successful",
      );
      setAmount("");
      ...
      console.error(e);
      showAlert(
        e?.shortMessage || e?.message || "Deposit failed",
        "error",
        "Deposit Failed",
      );
    } finally {
    ...
    <div className="max-w-5xl space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-[#d4af37]/70">
          Deposit into the protocol pool and earn yield.
        </p>
      </div>
        ...
        <Card className="lg:col-span-2 bg-[#0a0e17] border-[#d4af37]/20 p-8">
          ...
          <div className="space-y-6">
            ...
            <Button
              ...
              disabled={
                !amount || Number(amount) <= 0 || loading || !isConnected
              }
            ...
            <div className="text-[10px] text-gray-500">
              Uses USDC at{" "}
              <span className="text-gray-400">{addresses.USDC}</span>
            </div>
          </div>
        </Card>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-400 leading-relaxed">
                  ...
                  <span className="block text-gray-300 break-all">
                    {addresses.INSURANCE_POOL}
                  </span>
                  <span className="block text-gray-400">
                    Coverage percent depends on onchain rules.
                  </span>
                </p>
              </div>
            </div>
