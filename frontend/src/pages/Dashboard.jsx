...
function Dashboard() {
  ...
  const utilizationLabel =
    utilization < 50 ? "Safe: Below 50%" : utilization < 75 ? "Caution: Above 50%" : "High Risk: Above 75%";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="bg-[#1a1f3a] border-[#D4AF37]/20 p-5">
            ...
            <div className="w-full h-2 bg-[#0B1437] rounded-full overflow-hidden">
              <div className="h-full bg-emerald-500 rounded-full" style={{ width: `${Math.min(100, utilization)}%` }} />
            </div>
